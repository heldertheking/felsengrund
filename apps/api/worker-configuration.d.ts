/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57f06854ee4e06dfd714ef1c6dac3063)
// Runtime types generated with workerd@1.20251105.0 2026-09-07 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		KFA_SESSION_TTL_MS: "43200000";
		KFA_WORKER_ORIGIN: "https://felsengrund.jroliveirahelder.workers.dev";
		KFA_WEBPAGE_ORIGIN: "https://staging.kirche-felsengrund.ch";
		KFA_ALLOWED_ORIGINS: "http://localhost:4321,https://*.kirche-felsengrund.ch";
		KFA_NOTIFICATION_WEBHOOK: "https://automation.heldertheking.com/webhook/felsengrund-notification?env=local" | "https://automation.heldertheking.com/webhook/felsengrund-notification" | "https://automation.heldertheking.com/webhook/felsengrund-notification?env=development";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "KFA_SESSION_TTL_MS" | "KFA_WORKER_ORIGIN" | "KFA_WEBPAGE_ORIGIN" | "KFA_ALLOWED_ORIGINS" | "KFA_NOTIFICATION_WEBHOOK" | "KFA_ADMIN_PASSWORD">> {}
}
...
declare abstract class Navigator {
  sendBeacon(
    url: string,
    body?:
      ReadableStream | string | (ArrayBuffer | ArrayBufferView) | Blob | FormData | URLSearchParams | URLSearchParams,
  ): boolean;
...
type Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Input =
  Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Prompt | Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages | AsyncBatch;
...
type Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Input =
  Ai_Cf_Meta_Llama_4_Prompt | Ai_Cf_Meta_Llama_4_Messages | Ai_Cf_Meta_Llama_4_Async_Batch;
...
declare namespace TailStream {
  ...
  type EventType =
    Onset | Outcome | SpanOpen | SpanClose | DiagnosticChannelEvent | Exception | Log | Return | Attributes;
