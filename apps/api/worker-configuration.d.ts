/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6a0d6573805284a1ed1672f7f9cf6313)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PUBLIC_WORKER_ORIGIN: "https://felsengrund.jroliveirahelder.workers.dev";
		ALLOWED_ORIGINS: "http://localhost:4321,https://*.kirche-felsengrund.ch";
		STORAGE: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "N8N_WEBHOOK_URL" | "PUBLIC_WORKER_ORIGIN" | "ALLOWED_ORIGINS">> {}
}
