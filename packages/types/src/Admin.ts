...
export type CreateOfferInput = Omit<OfferFrontmatter, 'cardImage'> & { cardImage?: File; body?: string }
...
export type UpdatePodcastInput = Omit<CreatePodcastInput, 'audio'> & { audio?: File }
